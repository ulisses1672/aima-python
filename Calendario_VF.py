...
availability = {
    "Teacher1": [ ("Thursday", "3PM"), ("Friday", "5PM")],
    "Teacher2": [("Monday", "9AM"), ("Tuesday", "11AM"), ("Wednesday", "1PM"), ("Thursday", "3PM"), ("Friday", "5PM")],
    "Teacher3": [("Monday", "9AM"), ("Wednesday", "1PM"), ("Thursday", "3PM"), ("Friday", "5PM")],
...
for class_ in class_info:
    ...
    domains[class_] = [(time_slot, room) for time_slot in time_slots[:25] if time_slot in availability[teacher] for room in rooms]
     #20 slots de tempo disponiveis para cada professor
...
def constraint(A, a, B, b):
    # Check if the time slots are different and not consecutive
...
lo = 0
# Print the solution in an easier-to-understand way
